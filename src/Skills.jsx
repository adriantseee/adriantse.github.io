        ...
        <div id = "skills-wrapper">
            ...
            <div>
                ...
                <div>
                    ...
                    >
                        <div style={{backgroundColor: openMenu === 0 ? "#dcc9a8" : "black", borderBottom: "0.5px solid white", borderRadius: openMenu === 0 ? "5px" : "0px", overflow: "hidden"}}>
                            <div className="menu-skill" layout="position" style={{fontFamily: "Futura"}}>
                            ...
                            <div className={openMenu === 0 ? 'skill-icons show' : 'skill-icons'} style={{backgroundColor: openMenu === 0 ? "#dcc9a8" : "black"}}>
                    ...
                    <motion.div layout onClick={() => toggleMenu(1)} style={{border: "0px", minWidth: "300px"}}
                        ...
                        onMouseLeave={() => toggleHover(null)}
                    >
                        <div style={{backgroundColor: openMenu === 1 ? "#dcc9a8" : "black", borderBottom: "0.5px solid white", borderRadius: openMenu === 1 ? "5px" : "0px", overflow: "hidden"}}>
                            <div className="menu-skill" style={{fontFamily: "Futura"}}>
                            ...
                            <div className={openMenu === 1 ? 'skill-icons show' : 'skill-icons'} style={{backgroundColor: openMenu === 1 ? "#dcc9a8" : "black"}}>
                    ...
                    <motion.div layout onClick={() => toggleMenu(2)} style={{border: "0px", minWidth: "300px"}}
                        ...
                        onMouseLeave={() => toggleHover(null)}
                    >
                        <div style={{backgroundColor: openMenu === 2 ? "#dcc9a8" : "black", borderBottom: "0.5px solid white", borderRadius: openMenu === 2 ? "5px" : "0px", overflow: "hidden"}}>
                            <div className="menu-skill" style={{fontFamily: "Futura"}}>
                            ...
                            <div className={openMenu === 2 ? 'skill-icons show' : 'skill-icons'} style={{backgroundColor: openMenu === 2 ? "#dcc9a8" : "black"}}>
